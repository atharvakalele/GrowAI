...
def find_project_dir(start_dir):
    ...
    while True:
        ...
        if parent == current:
            raise RuntimeError("Project root not found for scheduler")
        current = parent
